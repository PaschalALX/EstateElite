...
from ..views.api import AllUsers, UserProperties, UserProperty, SingleUser
...
api_users_bp.add_url_rule('/<string:id>/properties',
                          view_func=UserProperties.as_view('user_properties'),
                          methods=['GET', 'POST'])
...
api_users_bp.add_url_rule('/<string:user_id>',
