...
const BlogsView = ({
    ...
    return (
        <div className="relative">
            ...
            <div className="mb-10 w-[90%] m-auto flex my-10 rounded-xl overflow-hidden shadow-lg shadow-black relative bg-white text-justify">
                ...
                <div className="flex-grow  overflow-auto text-gray-500 px-3 " >
